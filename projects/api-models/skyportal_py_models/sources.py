...
class SourcesPageResponse(BaseModel):
    ...
    # Explains why an annotation-filtered query matched nothing.
    hint: str | None = None
...
__all__ = [
    ...
    "SourceObservabilityPlotGetQuery",
