...
class PhotometryPointValidationResponse(BaseModel):
...
class _SerializedPhotometryResponse(BaseModel):
    ...
    validations: list[PhotometryPointValidationResponse] = Field(default_factory=list)
...
__all__ = [
    ...
    "PhotometryFlexibleBody",
    "PhotometryGetQuery",
    "PhotometryPatchBody",
    "PhotometryPatchQuery",
    "PhotometryPointResponse",
    "PhotometryPointValidationResponse",
    "PhotometryPost",
    "PhotometryPostBody",
    "PhotometryPostQuery",
