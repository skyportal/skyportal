...
Revision ID: 016e5651133b
Revises: 5df4b399aae2
Create Date: 2022-03-20 21:53:06.310897
...
def upgrade():
    ...
    op.create_index(op.f('ix_shift_users_created_at'), 'shift_users', ['created_at'], unique=False)
    op.create_index('shift_users_forward_ind', 'shift_users', ['shift_id', 'user_id'], unique=True)
    op.create_index('shift_users_reverse_ind', 'shift_users', ['user_id', 'shift_id'], unique=False)
