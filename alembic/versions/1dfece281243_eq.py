...
Revision ID: 1dfece281243
Revises: 2c856b2845f2
Create Date: 2022-08-31 22:59:01.041960
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('event_uri', sa.String(), nullable=True, comment='Earthquake URI'),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            nullable=False,
            comment='Earthquake lockloss measured',
        ),
        sa.ForeignKeyConstraint(
            ['detector_id'],
            ['mmadetectors.id'],
    ...
    op.create_table(
        ...
        sa.Column('depth', sa.Float(), nullable=False, comment='Depth'),
        sa.Column('magnitude', sa.Float(), nullable=False, comment='Magnitude'),
        sa.Column('date', sa.DateTime(), nullable=False, comment='UTC event timestamp'),
        sa.ForeignKeyConstraint(
            ['event_id'],
            ['earthquakeevents.event_id'],
        ),
        sa.ForeignKeyConstraint(['sent_by_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    )
