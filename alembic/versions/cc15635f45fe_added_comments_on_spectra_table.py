...
def upgrade():
    ...
    op.create_index(
        'group_comment_on_spectrum_forward_ind',
        'group_comment_on_spectrum',
        ['group_id', 'commentonspectrum_id'],
        unique=True,
    )
    op.create_index(
        'group_comment_on_spectrum_reverse_ind',
        'group_comment_on_spectrum',
        ['commentonspectrum_id', 'group_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_group_comment_on_spectrum_created_at'),
        'group_comment_on_spectrum',
        ['created_at'],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f('ix_group_comment_on_spectrum_created_at'),
        table_name='group_comment_on_spectrum',
    )
    op.drop_index(
        'group_comment_on_spectrum_reverse_ind', table_name='group_comment_on_spectrum'
    )
    op.drop_index(
        'group_comment_on_spectrum_forward_ind', table_name='group_comment_on_spectrum'
    )
    op.drop_table('group_comment_on_spectrum')
    op.drop_index(
