...
test_alert_stream_ingest: ## Run alert stream demo test
test_alert_stream_ingest: paths dependencies fill_conf_values
	@PYTHONPATH='.' ./baselayer/tools/test_frontend.py ./skyportal/tests/stream_ingest.py
