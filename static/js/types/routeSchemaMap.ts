...
export const ROUTE_SCHEMA_MAP = {
  ...
  "GET /api/sources_in_gcn/{dateobs}": { schema: "GcnEventObj" as const, list: true },
  "GET /api/sources_in_gcn/{dateobs}/{source_id}": { schema: "GcnEventObj" as const, list: true },
  ...
  "PATCH /api/photometric_series/{photometric_series_id}": { schema: "PhotometricSeriesResponse" as const, list: false },
  "PATCH /api/photometry/{photometry_id}/validation": { schema: "PhotometryValidationResponse" as const, list: false },
  "PATCH /api/sources/{obj_id}": { schema: "Obj" as const, list: false },
  "PATCH /api/sources_in_gcn/{dateobs}/{source_id}": { schema: "GcnEventObjIdResponse" as const, list: false },
  "POST /api/allocation": { schema: "AllocationPostResponse" as const, list: false },
  "POST /api/assignment": { schema: "AssignmentPostResponse" as const, list: false },
  "POST /api/default_followup_request": { schema: "DefaultFollowupRequestPostResponse" as const, list: false },
  "POST /api/default_gcn_tag": { schema: "DefaultGcnTagPostResponse" as const, list: false },
  "POST /api/default_observation_plan": { schema: "DefaultObservationPlanPostResponse" as const, list: false },
  "POST /api/default_survey_efficiency": { schema: "DefaultSurveyEfficiencyPostResponse" as const, list: false },
  "POST /api/earthquake": { schema: "EarthquakePostResponse" as const, list: false },
  ...
  "POST /api/followup_request": { schema: "FollowupRequestPostResponse" as const, list: false },
  "POST /api/galaxy_catalog/ascii": { schema: "Galaxy" as const, list: true },
  "POST /api/gcn_event": { schema: "GcnEventPostResponse" as const, list: false },
  "POST /api/gcn_event/tags/{dateobs}": { schema: "GcnEventTagPostResponse" as const, list: false },
  "POST /api/gcn_event/{dateobs}/report/{report_id}": { schema: "GcnReportPostResponse" as const, list: false },
  "POST /api/gcn_event/{dateobs}/summary/{summary_id}": { schema: "GcnSummaryPostResponse" as const, list: false },
  "POST /api/group_admission_requests": { schema: "GroupAdmissionRequestPostResponse" as const, list: false },
  "POST /api/groups": { schema: "GroupPostResponse" as const, list: false },
  "POST /api/groups/{group_id}/streams": { schema: "GroupStreamPostResponse" as const, list: false },
  "POST /api/groups/{group_id}/users": { schema: "GroupUserPostResponse" as const, list: false },
  "POST /api/instrument": { schema: "InstrumentPostResponse" as const, list: false },
  ...
  "POST /api/mmadetector": { schema: "MMADetectorPostResponse" as const, list: false },
  "POST /api/mmadetector/spectra": { schema: "MMADetectorSpectrumPostResponse" as const, list: false },
  "POST /api/mmadetector/time_intervals": { schema: "MMADetectorTimeIntervalPostResponse" as const, list: false },
  "POST /api/objtag": { schema: "ObjTag" as const, list: false },
  "POST /api/objtagoption": { schema: "ObjTagOption" as const, list: false },
  "POST /api/observation_plan": { schema: "ObservationPlanRequestPostResponse" as const, list: false },
  "POST /api/observation_plan/manual": { schema: "ObservationPlanManualPostResponse" as const, list: false },
  "POST /api/observation_plan/{observation_plan_request_id}/queue": { schema: "ObservationPlanRequest" as const, list: false },
  "POST /api/observing_run": { schema: "ObservingRunPostResponse" as const, list: false },
  "POST /api/photometric_series": { schema: "PhotometricSeriesResponse" as const, list: false },
  "POST /api/photometry": { schema: "PhotometryPostResponse" as const, list: false },
  "POST /api/photometry/{photometry_id}/validation": { schema: "PhotometryValidationResponse" as const, list: false },
  "POST /api/public_pages/release": { schema: "PublicReleasePostResponse" as const, list: false },
  "POST /api/public_pages/source/{source_id}": { schema: "PublicSourcePagePostResponse" as const, list: false },
  "POST /api/recurring_api": { schema: "RecurringAPIPostResponse" as const, list: false },
  "POST /api/sharing_service/{sharing_service_id}/coauthor/{user_id}": { schema: "SharingServiceCoauthorPostResponse" as const, list: false },
  "POST /api/sharing_service/{sharing_service_id}/group/{group_id}/auto_publisher/{user_id}": { schema: "SharingServiceGroupAutoPublisherPostResponse" as const, list: false },
  "POST /api/shifts": { schema: "ShiftPostResponse" as const, list: false },
  "POST /api/shifts/{shift_id}/users": { schema: "ShiftUserPostResponse" as const, list: false },
  "POST /api/sources_in_gcn/{dateobs}/{source_id}": { schema: "GcnEventObjIdResponse" as const, list: false },
  "POST /api/spatial_catalog": { schema: "SpatialCatalogPostResponse" as const, list: false },
  "POST /api/spatial_catalog/ascii": { schema: "SpatialCatalogASCIIFilePostResponse" as const, list: false },
  "POST /api/spectra": { schema: "SpectrumPostResponse" as const, list: false },
  "POST /api/spectra/ascii": { schema: "SpectrumASCIIPostResponse" as const, list: false },
  "POST /api/spectra/parse/ascii": { schema: "SpectrumNoID" as const, list: false },
  "POST /api/spectrum": { schema: "SpectrumPostResponse" as const, list: false },
  "POST /api/spectrum/ascii": { schema: "SpectrumASCIIPostResponse" as const, list: false },
  ...
  "POST /api/summary_query": { schema: "SummaryQueryPostResponse" as const, list: false },
  ...
  "POST /api/user": { schema: "UserPostResponse" as const, list: false },
  "POST /api/{associated_resource_type}/{resource_id}/annotations": { schema: "AnnotationPostResponse" as const, list: false },
  "POST /api/{associated_resource_type}/{resource_id}/comments": { schema: "CommentPostResponse" as const, list: false },
  "POST /api/{associated_resource_type}/{resource_id}/comments/{ignore_args}": { schema: "CommentPostResponse" as const, list: false },
  "POST /api/{associated_resource_type}/{resource_id}/reminders": { schema: "ReminderPostResponse" as const, list: false },
  "PUT /api/followup_request/{followup_request_id}/comment": { schema: "FollowupRequestCommentPutResponse" as const, list: false },
  "PUT /api/photometry": { schema: "PhotometryPutResponse" as const, list: false },
  "PUT /api/sharing_service/{existing_id}": { schema: "SharingServicePutResponse" as const, list: false },
  "PUT /api/sharing_service/{sharing_service_id}/group/{group_id}": { schema: "SharingServiceGroupPutResponse" as const, list: false },
