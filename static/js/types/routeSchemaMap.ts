...
export const ROUTE_SCHEMA_MAP = {
  ...
  "GET /api/allocation/{allocation_id}": { schema: "Allocation" as const, list: false },
  ...
  "GET /api/earthquake": { schema: "EarthquakeEvent" as const, list: true },
  ...
  "GET /api/followup_request": { schema: "FollowupRequest" as const, list: true },
  "GET /api/followup_request/{followup_request_id}": { schema: "FollowupRequest" as const, list: false },
  "GET /api/galaxy_catalog/{catalog_name}": { schema: "Galaxy" as const, list: true },
  "GET /api/gcn_event/properties": { schema: "GcnProperty" as const, list: true },
  "GET /api/gcn_event/tags": { schema: "GcnTag" as const, list: true },
  ...
  "GET /api/observation_plan": { schema: "ObservationPlanRequest" as const, list: true },
  ...
  "GET /api/sharing_service/submission": { schema: "SharingServiceSubmission" as const, list: true },
  ...
  "GET /api/{analysis_resource_type}/analysis": { schema: "ObjAnalysis" as const, list: true },
  "GET /api/{analysis_resource_type}/analysis/{analysis_id}": { schema: "ObjAnalysis" as const, list: false },
  "GET /api/{analysis_resource_type}/{analysis_id}": { schema: "ObjAnalysis" as const, list: true },
  "GET /api/{analysis_resource_type}/{analysis_id}/analysis": { schema: "ObjAnalysis" as const, list: false },
...
} satisfies Record<string, { schema: SchemaName; list: boolean }>;
