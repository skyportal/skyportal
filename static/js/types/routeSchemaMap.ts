...
export const ROUTE_SCHEMA_MAP = {
  ...
  "DELETE /api/earthquake/{earthquake_id}/mmadetector/{mma_detector_id}/measurements":
    { schema: "Success" as const, list: false },
  ...
  "DELETE /api/observation_plan/{observation_plan_request_id}/fields": {
    schema: "ObservationPlanRequest" as const,
    list: false,
  },
  ...
  "GET /api/allocation/{allocation_id}": {
    schema: "Allocation" as const,
    list: false,
  },
  "GET /api/analysis_service": {
    schema: "AnalysisService" as const,
    list: true,
  },
  ...
  "GET /api/analysis_service/{analysis_service_id}/default_analysis": {
    schema: "DefaultAnalysis" as const,
    list: true,
  },
  "GET /api/analysis_service/{analysis_service_id}/default_analysis/{default_analysis_id}":
    { schema: "DefaultAnalysis" as const, list: false },
  "GET /api/assignment": { schema: "ClassicalAssignment" as const, list: true },
  "GET /api/assignment/{assignment_id}": {
    schema: "ClassicalAssignment" as const,
    list: false,
  },
  "GET /api/candidates/scan_reports": {
    schema: "ScanReport" as const,
    list: true,
  },
  "GET /api/candidates/scan_reports/{report_id}/items/{_}": {
    schema: "ScanReportItem" as const,
    list: true,
  },
  "GET /api/candidates/{obj_id}": { schema: "Obj" as const, list: false },
  "GET /api/classification/{classification_id}": {
    schema: "Classification" as const,
    list: false,
  },
  "GET /api/default_followup_request": {
    schema: "DefaultFollowupRequest" as const,
    list: true,
  },
  ...
  "GET /api/default_gcn_tag/{default_gcn_tag_id}": {
    schema: "DefaultGcnTag" as const,
    list: false,
  },
  "GET /api/default_observation_plan": {
    schema: "DefaultObservationPlanRequest" as const,
    list: true,
  },
  ...
  "GET /api/default_survey_efficiency": {
    schema: "DefaultSurveyEfficiencyRequest" as const,
    list: true,
  },
  ...
  "GET /api/earthquake/{earthquake_id}/mmadetector/{mma_detector_id}/measurements":
    { schema: "EarthquakeMeasured" as const, list: false },
  "GET /api/earthquake/{event_id}": {
    schema: "EarthquakeEvent" as const,
    list: false,
  },
  ...
  "GET /api/followup_request": {
    schema: "FollowupRequest" as const,
    list: true,
  },
  ...
  "GET /api/gcn_event/{gcnevent_id}/survey_efficiency": {
    schema: "SurveyEfficiencyForObservations" as const,
    list: true,
  },
  "GET /api/group_admission_requests": {
    schema: "GroupAdmissionRequest" as const,
    list: true,
  },
  ...
  "GET /api/observation_plan/{observation_plan_request_id}": {
    schema: "ObservationPlanRequest" as const,
    list: false,
  },
  ...
  "GET /api/sources_in_gcn/{dateobs}/{source_id}": {
    schema: "SourcesConfirmedInGCN" as const,
    list: false,
  },
  "GET /api/spectra/{spectrum_id}": {
    schema: "Spectrum" as const,
    list: false,
  },
  ...
  "GET /api/survey_efficiency/observation_plan/{survey_efficiency_analysis_id}":
    { schema: "SurveyEfficiencyForObservationPlan" as const, list: false },
  ...
  "GET /api/{associated_resource_type}/{resource_id}/annotations/{annotation_id}":
    { schema: "Annotation" as const, list: false },
  "GET /api/{associated_resource_type}/{resource_id}/comments": {
    schema: "Comment" as const,
    list: true,
  },
  ...
  "PATCH /api/analysis_service/{analysis_service_id}": {
    schema: "AnalysisService" as const,
    list: false,
  },
  "PATCH /api/candidates/scan_reports/{report_id}/items/{item_id}": {
    schema: "ScanReportItem" as const,
    list: false,
  },
  "PATCH /api/earthquake/{earthquake_id}/mmadetector/{mma_detector_id}/measurements":
    { schema: "EarthquakeMeasured" as const, list: false },
  "PATCH /api/groups/{group_id}/users": {
    schema: "GroupUser" as const,
    list: false,
  },
  ...
  "PATCH /api/photometric_series/{photometric_series_id}": {
    schema: "PhotometricSeries" as const,
    list: false,
  },
  ...
  "POST /api/analysis_service": {
    schema: "AnalysisService" as const,
    list: false,
  },
  "POST /api/analysis_service/{analysis_service_id}/default_analysis": {
    schema: "DefaultAnalysis" as const,
    list: false,
  },
  "POST /api/candidates/scan_reports": {
    schema: "ScanReport" as const,
    list: false,
  },
  ...
  "POST /api/earthquake/{earthquake_id}/mmadetector/{mma_detector_id}/predictions":
    { schema: "EarthquakePrediction" as const, list: false },
  ...
  "POST /api/gcn_event/tags/{dateobs}": {
    schema: "GcnTag" as const,
    list: false,
  },
  "POST /api/groups/{group_id}/streams": {
    schema: "GroupStream" as const,
    list: false,
  },
  ...
  "POST /api/groups/{group_id}/usersFromGroups": {
    schema: "GroupUser" as const,
    list: false,
  },
  ...
  "POST /api/photometric_series": {
    schema: "PhotometricSeries" as const,
    list: false,
  },
  "POST /api/sharing_service/submission": {
    schema: "SharingServiceSubmission" as const,
    list: false,
  },
  "POST /api/sharing_service/{sharing_service_id}/coauthor/{user_id}": {
    schema: "SharingServiceCoauthor" as const,
    list: false,
  },
  "POST /api/sharing_service/{sharing_service_id}/group/{group_id}/auto_publisher/{user_id}":
    { schema: "SharingServiceGroupAutoPublisher" as const, list: false },
  "POST /api/shifts": { schema: "Shift" as const, list: false },
  "POST /api/shifts/{shift_id}/users": {
    schema: "ShiftUser" as const,
    list: false,
  },
  "POST /api/source_notifications": {
    schema: "SourceNotification" as const,
    list: false,
  },
  ...
  "POST /api/sources/{obj_id}/annotations/ps1": {
    schema: "Annotation" as const,
    list: false,
  },
  ...
  "POST /api/sources_in_gcn/{dateobs}/{source_id}": {
    schema: "SourcesConfirmedInGCN" as const,
    list: false,
  },
  "POST /api/spectra/parse/ascii": {
    schema: "SpectrumNoID" as const,
    list: false,
  },
  ...
  "POST /api/streams/{stream_id}/users": {
    schema: "StreamUser" as const,
    list: false,
  },
  ...
  "POST /api/{analysis_resource_type}/{resource_id}/analysis/{analysis_service_id}":
    { schema: "ObjAnalysis" as const, list: false },
  ...
  "POST /api/{associated_resource_type}/{resource_id}/comments/{ignore_args}": {
    schema: "Comment" as const,
    list: false,
  },
  ...
  "PUT /api/observing_run/{run_id}": {
    schema: "ObservingRun" as const,
    list: false,
  },
  "PUT /api/sharing_service/{existing_id}": {
    schema: "SingleSharingService" as const,
    list: false,
  },
  "PUT /api/sharing_service/{sharing_service_id}/group/{group_id}": {
    schema: "SharingServiceGroup" as const,
    list: false,
  },
