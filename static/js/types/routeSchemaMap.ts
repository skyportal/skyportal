...
export const ROUTE_SCHEMA_MAP = {
  ...
  "PATCH /api/sources_in_gcn/{dateobs}/{source_id}": { schema: "SourcesConfirmedInGCNIdResponse" as const, list: false },
  ...
  "POST /api/sources_in_gcn/{dateobs}/{source_id}": { schema: "SourcesConfirmedInGCNIdResponse" as const, list: false },
