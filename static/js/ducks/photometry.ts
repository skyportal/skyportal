...
export function fetchSourcePhotometry(
  id: number | string,
...
export function deletePhotometry(id: number | string) {
  return API.DELETE(`/api/photometry/${id}`, DELETE_PHOTOMETRY);
}

export function submitPhotometry(photometry: any) {
  return API.POST(
...
export function updatePhotometry(id: number | string, photometry: any) {
  return API.PATCH(
