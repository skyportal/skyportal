...
interface SourceTableFilterFormProps {
  handleFilterSubmit: (...args: any[]) => void;
  spatialCatalogQuery?: boolean;
}

const SourceTableFilterForm = ({
  handleFilterSubmit,
  spatialCatalogQuery = true,
}: SourceTableFilterFormProps) => {
  const { classes }: { classes: any } = useStyles();
  ...
  latestTaxonomyList?.forEach((taxonomy: any) => {
    const currentClasses = allowedClasses(taxonomy.hierarchy).map(
      (option: any) => `${taxonomy.name}: ${option.class}`,
    );
      ...
      if (formData.spatialcatalogid !== "") {
        ...
        if (formData.spatialcatalogentryid !== "") {
          formData.spatialCatalogEntryName = spatialCatalog?.entries?.filter(
            (l: any) => l.id === formData.spatialcatalogentryid,
          )[0]?.entry_name;
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                name="sourceID"
                inputRef={register("sourceID") as any}
                onChange={onChange}
                value={value}
              />
            )}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                label="Saved After"
                name="savedAfter"
                inputRef={register("savedAfter") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                label="Saved Before"
                name="savedBefore"
                inputRef={register("savedBefore") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                name="startDate"
                inputRef={register("startDate") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                name="endDate"
                inputRef={register("endDate") as any}
                placeholder="2012-08-30T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                type="text"
                name="simbadClass"
                inputRef={register("simbadClass") as any}
                onChange={onChange}
                value={value}
              />
            )}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <Select
                ...
                value={value}
                onChange={(event) => {
                  setSelectedClassifications(event.target.value as any);
                ...
                renderValue={(selected: any) => (
                  <div className={classes.chips}>
                    {selected.map((classification: any) => (
                      <Chip
                        key={classification}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <Select
                ...
                value={value}
                onChange={(event) => {
                  setSelectedNonClassifications(event.target.value as any);
                  onChange(event.target.value);
                }}
                input={
                  <Input
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                type="text"
                name="alias"
                inputRef={register("alias") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                type="text"
                name="origin"
                inputRef={register("origin") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                type="text"
                name="commentsFilter"
                inputRef={register("commentsFilter") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("annotationsFilter") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("commentsFilterAuthor") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("annotationsFilterOrigin") as any}
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("commentsFilterAfter") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("commentsFilterBefore") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("annotationsFilterAfter") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("annotationsFilterBefore") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("hasSpectrumAfter") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("hasSpectrumBefore") as any}
                placeholder="2021-01-01T00:00:00"
                onChange={onChange}
                value={value}
              />
          ...
          <Controller
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                inputRef={register("followupRequestStatus") as any}
                onChange={onChange}
                value={value}
              />
            )}
                    ...
                    reset({
                      ...
                      localizationid:
                        event.target.value === -1
                          ? ""
                          : gcnEventsLookUp[event.target.value as any]
                              ?.localizations[0]?.id || "",
                    });
              ...
              <div className={classes.selectItems}>
                ...
                <Controller
                  render={({ field: { onChange, value } }) => (
                    ...
                    >
                      {spatialCatalog?.entries?.map(
                        (spatialCatalogEntry: any) => (
                          <MenuItem
