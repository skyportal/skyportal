...
const HeaderContent = () => {
  ...
  return (
    <div
      className={classes.topBannerContent}
      style={{ justifyContent: openSearch ? "flex-end" : "space-between" }}
    >
      <Link
        onClick={() => dispatch(hydrate())}
        to="/"
        style={{
          display: openSearch ? "none" : "inline-flex",
          flexDirection: "row",
          alignItems: "center",
          textDecoration: "none",
        }}
      >
        ...
        <p className={classes.title}>SkyPortal</p>
      </Link>
        ...
        <Box display={{ xs: "none", md: "block" }}>
          <Tooltip title="Refresh basic data">
            ...
            >
              <RefreshIcon
                fontSize="large"
                style={{ color: refreshing ? "grey" : "#457b9d" }}
              />
            </IconButton>
          </Tooltip>
        </Box>
      ...
      <Box
        display={{ xs: openSearch ? "flex" : "none", md: "none" }}
        style={{
          paddingRight: "0.5rem",
          flexDirection: "row",
          alignItems: "center",
      ...
      >
        <QuickSearchBar />
        <IconButton onClick={() => setOpenSearch(false)} size="large">
