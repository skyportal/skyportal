  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        popupText:
          "Summaries are generated by whichever model this instance configures. To use your own OpenAI account instead, set your API key here. That is a paid service, and while it costs little per source (<$0.01) it can add up. You can get a key here: https://platform.openai.com/account/api-keys",
