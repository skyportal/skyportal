...
interface NotificationSettingsSelectProps {
  notificationResourceType?: string;
}
...
const NotificationSettingsSelect = ({
  ...
  const [valueWhatsapp, setValueWhatsapp] = useState<any>();
