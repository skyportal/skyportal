...
const format = (date: any) => date.format("YYYY-MM-DDTHH:mm:ss");
const fromUtcToLocal = (date: any) => format(dayjs(`${date}Z`).local());
const fromLocalToUtc = (date: any) => format(dayjs(date).utc());
