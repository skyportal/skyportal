...
const ShiftSummary = () => {
  ...
  function displayShiftsList(shifts: any[]) {
    return (
      <List>
        <h2>Shifts:</h2>
        {shifts.map((shift) => (
  ...
  function gcnInfo(gcn: any, shifts: any[]) {
    return (
  ...
  function displayShiftsGCN(shifts: any[], gcns: any[]) {
    return (
      <List>
        <h2>GCN Events:</h2>
        {gcns.map((gcn) => (
