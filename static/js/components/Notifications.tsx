...
const ago = (ms: number) =>
  new Date(Date.now() - ms).toISOString().slice(0, -1);
const DEMO_NOTIFICATIONS: UserNotification[] = [
  [
    "mention",
    "*@mcoughlin* mentioned you in a comment on *ZTF26aaaqrst*",
    null,
  ],
  [
    "reminder_source",
    "*@jsmith* created a reminder on source *ZTF26aakkllm*",
    null,
  ],
  [
    "gcn_report",
    "GCN report *nightly-summary* on *2026-09-08T00:36:53* created.",
    null,
  ],
  [
    "sources_new_classification",
    "New classification *SN Ia* for source *ZTF26aabbccd*",
    null,
  ],
  ["sources_new_spectrum", "New spectrum for source *ZTF26aabbccd*", null],
  [
    "gcn_events",
    "New GCN Event *2026-09-08 00:36:53*, with Notice Type *FERMI_GBM_GND_POS*",
    null,
  ],
  [
    "favorite_sources_new_activity",
    "New activity around favorite source *ZTF26aaqqrrs* (within 5.0 arcsec)",
    null,
  ],
  [
    "group_admission_request",
    "New Group Admission Request from *@jsmith* for Group *ZTF Partnership*",
    null,
  ],
  [
    "analysis_services",
    "New completed analysis service for object *ZTF26aabbccd* with name *sn-fit*",
    null,
  ],
  [
    "facility_transactions",
    "New Follow-up submission for object *ZTF26aabbccd* by *SEDM* by user *@jsmith*",
    null,
  ],
  [
    "observation_plans",
    "New Observation Plan submission for GcnEvent *2026-09-08 00:36:53* for *ZTF* by user *@jsmith*",
    null,
  ],
  ["Recurring API", "Successfully called recurring API 3", null],
  [
    null,
    "*@jsmith* needs a replacement for shift: Night shift from 2026-09-12 to 2026-09-13.",
    "/shifts/12",
  ],
  [
    null,
    "*jsmith* asked for 3 of your dataset(s) on *ZTF26aabbccd*",
    "/data_access_requests",
  ],
  [
    null,
    "Your request for data on *ZTF26aabbccd* was *approved*",
    "/source/ZTF26aabbccd",
  ],
].map(([notification_type, text, url], index) => ({
  id: -1 - index,
  text: text as string,
  url: url as string | null,
  viewed: index > 2,
  notification_type: notification_type as string | null,
  created_at: ago((index + 1) * 3600000),
}));
