...
const Crossmatch = () => {
  ...
  const [selectedGcnEventId1, setSelectedGcnEventId1] = useState<any>(null);
  const [selectedLocalizationId1, setSelectedLocalizationId1] =
    useState<any>(null);
  const [selectedGcnEventId2, setSelectedGcnEventId2] = useState<any>(null);
  const [selectedLocalizationId2, setSelectedLocalizationId2] =
    useState<any>(null);
