...
const FollowupRequestForm = ({
  ...
  const onSubmit = () => {
    ...
    formData.editable =
      obsParams[instIDToName[formData.instrument_id]].requestsEditable;
    if (action === "createNew") {
    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
              ...
              as={
                <Select labelId="instrumentSelectLabel">
                  {instrumentList
                    .filter(
                      (instrument) =>
                        instrument.telescope_id in telLookUp &&
        ...
        {formState.instrument_id && (
          <div>
            {!obsParams[instIDToName[formState.instrument_id]]
              .requestsEditable && (
            ...
            <div>
              {obsParams[instIDToName[formState.instrument_id]].filters.type ===
                "checkbox" && (
                <div>
                  {errors.filters && (
                  ...
                  <label>Filters:&nbsp;&nbsp;</label>
                  {obsParams[
                    instIDToName[formState.instrument_id]
              ...
              {Object.keys(
                ...
                <div>
                  ...
                  >
                    {obsParams[
                      instIDToName[formState.instrument_id]
                    ].exposureTime.options.map((expTime) => (
            ...
            <input
              type="submit"
              name={`${action}FollowupRequestSubmitButton`}
            />
          </div>
        )}
      </form>
