...
interface LocalizationPropertiesSelectProps {
  ...
  setSelectedLocalizationProperties: (...args: any[]) => void;
...
const LocalizationPropertiesSelect = ({
  ...
  const handleSubmitProperties = async () => {
    ...
    setSelectedLocalizationProperties((prev: string[]) => [
      ...prev,
      propertiesFilter,
    ]);
  };
    ...
    >
        ...
        <Controller
          ...
          render={({ field: { value } }) => (
            <FormControl fullWidth>
              ...
              >
                {localizationProperties?.map((prop: any) => (
      ...
      <Box sx={{ display: "flex", gap: "0.2rem" }}>
        <ButtonGroup variant="outlined" color="primary">
          ...
          <Button variant="outlined" primary onClick={reset as any}>
            Reset
          </Button>
        </ButtonGroup>
        <SelectWithChips
          ...
          onChange={(e: any) =>
            setSelectedLocalizationProperties(e.target.value)
          }
