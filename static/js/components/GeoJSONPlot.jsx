...
const useD3 = (renderer, height, width, geoJSON1, geoJSON2) => {
  const svgRef = useRef();

  useEffect(() => {
    if (geoJSON1 || geoJSON2) {
      renderer(d3.select(svgRef.current), height, width, geoJSON1, geoJSON2);
    }
  }, [renderer, svgRef, geoJSON1, geoJSON2, height, width]);
