...
const IMAGE_EXTENSION_TO_TYPE: Record<string, string> = {
  apng: "image/apng",
  avif: "image/avif",
  bmp: "image/bmp",
  gif: "image/gif",
...
const readJsonFile = (commentAttachment: any, commentId: number) => {
  let jsonFile: Record<string, any> = {};
  try {
    jsonFile =
...
const readTextFile = (commentAttachment: any, commentId: number) => {
  let txtFile = "";
  try {
    txtFile =
      commentId === commentAttachment?.commentId
