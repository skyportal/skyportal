...
SPEC_LINES = {
    ...
    'O II'  : ([3390,3377,3713,3749,3954,3973,4076,4349,4416,4649,6641,6721], '#00a64d'),
    ...
    'Mg II' : ([2796, 2798, 2803, 4481, 7877, 7896, 8214, 8235, 9218, 9244, 9632], '#bf874e'),
    ...
    'Co II'  : ( [15759, 16064, 16361, 17239, 17462, 17772, 21347, 22205, 22497, 23613, 24596], '#ffe4e1'),

    'WR WN'  : ([4058, 4341, 4537, 4604, 4641, 4686, 4861, 4945, 5411, 5801, 6563, 7109, 7123, 10124], '#a55031' ), 
    # H: 4341,4861,6563; HeII: 4686,5411,10124; CIV: 5801; NIII: 4641; NIV: 4058,4537,7109,7123; NV: 4604,4945 
    'WR WC/O': ([3811, 3834, 3886, 4341, 4472, 4647, 4686, 4861, 5598, 5696, 5801, 5876, 6563, 6678, 6742, 7065, 7236, 7726, 9711], '#b9a44f' ),  
    # H: 4341,4861,6563; HeI: 7065,6678,5876,4472,3886; HeII: 4686; CII: 7236; CIII: 4647,5696,6742,9711; CIV: 5801,7726; OV: 5598; OVI: 3811,3834

    'Galaxy Lines': ([2025, 2056, 2062, 2066, 2249, 2260, 2343, 2374, 2382, 2576, 2586, 2594, 2599, 2798, 2852, 
                      3727, 3934, 3969, 4341, 4861, 4959, 5007, 5890, 5896, 6548, 6563, 6583, 6717, 6731], '#8357bd' ),
    #H 4341,4861,6563; NII 6548,6583; [OII] 3727; [OIII] 4959,5007; NaI 5890,5896; MgII 2798; SII 6717,6731; CaII H&K 3969,3934 ZnII 2025; CrII 2056,2062,2066; FeII 2249,2260,2343,2374,2382,2586,2599; MnII 2576,2594; MgI 2852


    #SNe typical lines : there's a problem maybe with the 
    # 'SN II'  :  ([3970,4102,4341,4861,6563, 10052,10941,12822,18756], '#ff0000'), # Balmer lines (something else?) 
    # 'SN Ia'  :  ([4128,4131,5958,5979,6347,6371,3159, 3180, 3706, 3737, 3934, 3969, 8498, 8542, 8662 ], '#5674b9'), # Si II,  Ca II, 
    # 'SN Ib'  :  ([3889,4471, 5876,6678,7065, 3159, 3180, 3706, 3737, 3934, 3969, 8498, 8542, 8662], '#002157') ,  # He I, Ca II (?)
    # 'SN Ic'  :  ([3159, 3180, 3706, 3737, 3934, 3969, 8498, 8542, 8662 ], '#005050') , # Ca II, O I
...
#       - Have some option for Ia/II/Ic etc 
