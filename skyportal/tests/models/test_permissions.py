...
FIXTURE_MODEL = {
    ...
    "public_assistant_message": "AssistantMessage",
    "public_assistant_query": "AssistantQuery",
    "public_assistant_query_subscription": "AssistantQuerySubscription",
    ...
    "public_classificationedit": "ClassificationEdit",
    ...
    "public_gcn_event_extraction": "GcnEventExtraction",
    ...
    "public_shift": "Shift",
    "public_source_interest": "SourceInterest",
...
CASES = [
    ...
    # --- ClassificationEdit  (public_classificationedit)  [probed] ---
    ("user", "public_classificationedit", "create", True),
    ("user", "public_classificationedit", "read", True),
    ("user", "public_classificationedit", "update", True),
    ("user", "public_classificationedit", "delete", True),
    ("user_group2", "public_classificationedit", "create", False),
    ("user_group2", "public_classificationedit", "read", False),
    ("user_group2", "public_classificationedit", "update", False),
    ("user_group2", "public_classificationedit", "delete", False),
    ("group_admin_user", "public_classificationedit", "create", True),
    ("group_admin_user", "public_classificationedit", "read", True),
    ("group_admin_user", "public_classificationedit", "update", True),
    ("group_admin_user", "public_classificationedit", "delete", True),
    ("super_admin_user", "public_classificationedit", "create", True),
    ("super_admin_user", "public_classificationedit", "read", True),
    ("super_admin_user", "public_classificationedit", "update", True),
    ("super_admin_user", "public_classificationedit", "delete", True),
    ...
    # --- GcnEventExtraction  (public_gcn_event_extraction)  [probed] ---
    ("user", "public_gcn_event_extraction", "create", True),
    ("user", "public_gcn_event_extraction", "read", True),
    ("user", "public_gcn_event_extraction", "update", True),
    ("user", "public_gcn_event_extraction", "delete", True),
    ("user_group2", "public_gcn_event_extraction", "create", True),
    ("user_group2", "public_gcn_event_extraction", "read", True),
    ("user_group2", "public_gcn_event_extraction", "update", False),
    ("user_group2", "public_gcn_event_extraction", "delete", False),
    ("group_admin_user", "public_gcn_event_extraction", "create", True),
    ("group_admin_user", "public_gcn_event_extraction", "read", True),
    ("group_admin_user", "public_gcn_event_extraction", "update", True),
    ("group_admin_user", "public_gcn_event_extraction", "delete", True),
    ("super_admin_user", "public_gcn_event_extraction", "create", True),
    ("super_admin_user", "public_gcn_event_extraction", "read", True),
    ("super_admin_user", "public_gcn_event_extraction", "update", True),
    ("super_admin_user", "public_gcn_event_extraction", "delete", True),
    ...
    # --- AssistantMessage  (public_assistant_message) ---
    ("user", "public_assistant_message", "create", True),
    ("user", "public_assistant_message", "read", True),
    ("user", "public_assistant_message", "update", True),
    ("user", "public_assistant_message", "delete", True),
    ("user_group2", "public_assistant_message", "create", False),
    ("user_group2", "public_assistant_message", "read", False),
    ("user_group2", "public_assistant_message", "update", False),
    ("user_group2", "public_assistant_message", "delete", False),
    ("group_admin_user", "public_assistant_message", "create", False),
    ("group_admin_user", "public_assistant_message", "read", False),
    ("group_admin_user", "public_assistant_message", "update", False),
    ("group_admin_user", "public_assistant_message", "delete", False),
    ("super_admin_user", "public_assistant_message", "create", True),
    ("super_admin_user", "public_assistant_message", "read", True),
    ("super_admin_user", "public_assistant_message", "update", True),
    ("super_admin_user", "public_assistant_message", "delete", True),
    # --- AssistantQuery  (public_assistant_query) ---
    # Read/create for members of the tied group; update/delete for the owner only.
    ("user", "public_assistant_query", "create", True),
    ("user", "public_assistant_query", "read", True),
    ("user", "public_assistant_query", "update", True),
    ("user", "public_assistant_query", "delete", True),
    ("user_group2", "public_assistant_query", "create", False),
    ("user_group2", "public_assistant_query", "read", False),
    ("user_group2", "public_assistant_query", "update", False),
    ("user_group2", "public_assistant_query", "delete", False),
    ("group_admin_user", "public_assistant_query", "create", True),
    ("group_admin_user", "public_assistant_query", "read", True),
    ("group_admin_user", "public_assistant_query", "update", False),
    ("group_admin_user", "public_assistant_query", "delete", False),
    ("super_admin_user", "public_assistant_query", "create", True),
    ("super_admin_user", "public_assistant_query", "read", True),
    ("super_admin_user", "public_assistant_query", "update", True),
    ("super_admin_user", "public_assistant_query", "delete", True),
    # --- AssistantQuerySubscription  (public_assistant_query_subscription) ---
    # A user's own opt-in: only that user (and a super admin) may touch it.
    ("user", "public_assistant_query_subscription", "create", True),
    ("user", "public_assistant_query_subscription", "read", True),
    ("user", "public_assistant_query_subscription", "update", True),
    ("user", "public_assistant_query_subscription", "delete", True),
    ("user_group2", "public_assistant_query_subscription", "create", False),
    ("user_group2", "public_assistant_query_subscription", "read", False),
    ("user_group2", "public_assistant_query_subscription", "update", False),
    ("user_group2", "public_assistant_query_subscription", "delete", False),
    ("group_admin_user", "public_assistant_query_subscription", "create", False),
    ("group_admin_user", "public_assistant_query_subscription", "read", False),
    ("group_admin_user", "public_assistant_query_subscription", "update", False),
    ("group_admin_user", "public_assistant_query_subscription", "delete", False),
    ("super_admin_user", "public_assistant_query_subscription", "create", True),
    ("super_admin_user", "public_assistant_query_subscription", "read", True),
    ("super_admin_user", "public_assistant_query_subscription", "update", True),
    ("super_admin_user", "public_assistant_query_subscription", "delete", True),
    ...
    # --- SourceInterest  (public_source_interest)  [PREDICTED - verify in CI] ---
    ("user", "public_source_interest", "create", True),
    ("user", "public_source_interest", "read", True),
    ("user", "public_source_interest", "update", False),
    ("user", "public_source_interest", "delete", False),
    ("user_group2", "public_source_interest", "create", True),
    ("user_group2", "public_source_interest", "read", True),
    ("user_group2", "public_source_interest", "update", False),
    ("user_group2", "public_source_interest", "delete", False),
    ("group_admin_user", "public_source_interest", "create", True),
    ("group_admin_user", "public_source_interest", "read", True),
    ("group_admin_user", "public_source_interest", "update", False),
    ("group_admin_user", "public_source_interest", "delete", False),
    ("super_admin_user", "public_source_interest", "create", True),
    ("super_admin_user", "public_source_interest", "read", True),
    ("super_admin_user", "public_source_interest", "update", True),
    ("super_admin_user", "public_source_interest", "delete", True),
    ...
    ("group_admin_user", "public_gcn_event_obj", "delete", True),
    ("super_admin_user", "public_gcn_event_obj", "create", True),
    ("super_admin_user", "public_gcn_event_obj", "read", True),
    ("super_admin_user", "public_gcn_event_obj", "update", True),
    ("super_admin_user", "public_gcn_event_obj", "delete", True),
