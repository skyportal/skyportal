def test_user_create_public_group(user, public_group, benchmark):
...
def test_user_create_public_groupuser(user, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_create_public_stream(user, public_stream, benchmark):
    def check_accessibility():
...
def test_user_create_public_groupstream(user, public_groupstream, benchmark):
    def check_accessibility():
...
def test_user_create_public_streamuser(user, public_streamuser, benchmark):
    def check_accessibility():
...
def test_user_create_public_filter(user, public_filter, benchmark):
    def check_accessibility():
...
def test_user_create_public_candidate_object(user, public_candidate_object, benchmark):
    def check_accessibility():
...
def test_user_create_public_source_object(user, public_source_object, benchmark):
    def check_accessibility():
...
def test_user_create_keck1_telescope(user, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_create_sedm(user, sedm, benchmark):
    def check_accessibility():
...
def test_user_create_public_group_sedm_allocation(
    user, public_group_sedm_allocation, benchmark
):
    def check_accessibility():
...
def test_user_read_public_group(user, public_group, benchmark):
    def check_accessibility():
...
def test_user_read_public_groupuser(user, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_read_public_stream(user, public_stream, benchmark):
    def check_accessibility():
...
def test_user_read_public_groupstream(user, public_groupstream, benchmark):
    def check_accessibility():
...
def test_user_read_public_streamuser(user, public_streamuser, benchmark):
    def check_accessibility():
...
def test_user_read_public_filter(user, public_filter, benchmark):
    def check_accessibility():
...
def test_user_read_public_candidate_object(user, public_candidate_object, benchmark):
    def check_accessibility():
...
def test_user_read_public_source_object(user, public_source_object, benchmark):
    def check_accessibility():
...
def test_user_read_keck1_telescope(user, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_read_sedm(user, sedm, benchmark):
    def check_accessibility():
...
def test_user_update_public_group(user, public_group, benchmark):
    def check_accessibility():
...
def test_user_update_public_groupuser(user, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_update_public_stream(user, public_stream, benchmark):
    def check_accessibility():
...
def test_user_update_public_groupstream(user, public_groupstream, benchmark):
    def check_accessibility():
...
def test_user_update_public_streamuser(user, public_streamuser, benchmark):
    def check_accessibility():
...
def test_user_update_public_filter(user, public_filter, benchmark):
    def check_accessibility():
...
def test_user_update_public_candidate_object(user, public_candidate_object, benchmark):
    def check_accessibility():
...
def test_user_update_public_source_object(user, public_source_object, benchmark):
    def check_accessibility():
...
def test_user_update_keck1_telescope(user, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_update_sedm(user, sedm, benchmark):
    def check_accessibility():
...
def test_user_delete_public_group(user, public_group, benchmark):
    def check_accessibility():
...
def test_user_delete_public_groupuser(user, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_delete_public_stream(user, public_stream, benchmark):
    def check_accessibility():
...
def test_user_delete_public_groupstream(user, public_groupstream, benchmark):
    def check_accessibility():
...
def test_user_delete_public_streamuser(user, public_streamuser, benchmark):
    def check_accessibility():
...
def test_user_delete_public_filter(user, public_filter, benchmark):
    def check_accessibility():
...
def test_user_delete_public_candidate_object(user, public_candidate_object, benchmark):
    def check_accessibility():
...
def test_user_delete_public_source_object(user, public_source_object, benchmark):
    def check_accessibility():
...
def test_user_delete_keck1_telescope(user, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_delete_sedm(user, sedm, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_group(user_group2, public_group, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_groupuser(user_group2, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_stream(user_group2, public_stream, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_groupstream(
    user_group2, public_groupstream, benchmark
):
    def check_accessibility():
...
def test_user_group2_create_public_streamuser(
    user_group2, public_streamuser, benchmark
):
    def check_accessibility():
...
def test_user_group2_create_public_filter(user_group2, public_filter, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_candidate_object(
    user_group2, public_candidate_object, benchmark
):
    def check_accessibility():
...
def test_user_group2_create_public_source_object(
    user_group2, public_source_object, benchmark
):
    def check_accessibility():
...
def test_user_group2_create_keck1_telescope(user_group2, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_group2_create_sedm(user_group2, sedm, benchmark):
    def check_accessibility():
...
def test_user_group2_create_public_group_sedm_allocation(
    user_group2, public_group_sedm_allocation, benchmark
):
    def check_accessibility():
...
def test_user_group2_read_public_group(user_group2, public_group, benchmark):
    def check_accessibility():
...
def test_user_group2_read_public_groupuser(user_group2, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_group2_read_public_stream(user_group2, public_stream, benchmark):
    def check_accessibility():
...
def test_user_group2_read_public_streamuser(user_group2, public_streamuser, benchmark):
    def check_accessibility():
...
def test_user_group2_read_public_filter(user_group2, public_filter, benchmark):
    def check_accessibility():
...
def test_user_group2_read_keck1_telescope(user_group2, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_group2_read_sedm(user_group2, sedm, benchmark):
    def check_accessibility():
...
def test_user_group2_update_public_group(user_group2, public_group, benchmark):
    def check_accessibility():
...
def test_user_group2_update_public_groupuser(user_group2, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_group2_update_public_stream(user_group2, public_stream, benchmark):
    def check_accessibility():
...
def test_user_group2_update_public_filter(user_group2, public_filter, benchmark):
    def check_accessibility():
...
def test_user_group2_update_keck1_telescope(user_group2, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_group2_update_sedm(user_group2, sedm, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_public_group(user_group2, public_group, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_public_groupuser(user_group2, public_groupuser, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_public_stream(user_group2, public_stream, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_public_filter(user_group2, public_filter, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_keck1_telescope(user_group2, keck1_telescope, benchmark):
    def check_accessibility():
...
def test_user_group2_delete_sedm(user_group2, sedm, benchmark):
    def check_accessibility():
...
def test_super_admin_user_create_public_group(
    super_admin_user, public_group, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_public_groupuser(
    super_admin_user, public_groupuser, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_public_stream(
    super_admin_user, public_stream, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_public_groupstream(
    super_admin_user, public_groupstream, benchmark
):
    def check_accessibility():
        accessible = public_groupstream.is_accessible_by(
...
def test_super_admin_user_create_public_streamuser(
    super_admin_user, public_streamuser, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_public_filter(
    super_admin_user, public_filter, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_public_candidate_object(
    super_admin_user, public_candidate_object, benchmark
):
    def check_accessibility():
        accessible = public_candidate_object.is_accessible_by(
            super_admin_user, mode="create"
...
def test_super_admin_user_create_public_source_object(
    super_admin_user, public_source_object, benchmark
):
    def check_accessibility():
        accessible = public_source_object.is_accessible_by(
            super_admin_user, mode="create"
        )
        assert accessible
...
def test_super_admin_user_create_keck1_telescope(
    super_admin_user, keck1_telescope, benchmark
):
    def check_accessibility():
...
def test_super_admin_user_create_sedm(super_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_super_admin_user_create_public_group_sedm_allocation(
    super_admin_user, public_group_sedm_allocation, benchmark
):
    def check_accessibility():
        accessible = public_group_sedm_allocation.is_accessible_by(
            super_admin_user, mode="create"
...
def test_super_admin_user_read_public_group(super_admin_user, public_group, benchmark):
    def check_accessibility():
...
def test_super_admin_user_read_sedm(super_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_super_admin_user_update_sedm(super_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_super_admin_user_delete_sedm(super_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_group_admin_user_create_public_group(
    group_admin_user, public_group, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_public_groupuser(
    group_admin_user, public_groupuser, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_public_stream(
    group_admin_user, public_stream, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_public_groupstream(
    group_admin_user, public_groupstream, benchmark
):
    def check_accessibility():
        accessible = public_groupstream.is_accessible_by(
...
def test_group_admin_user_create_public_streamuser(
    group_admin_user, public_streamuser, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_public_filter(
    group_admin_user, public_filter, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_public_candidate_object(
    group_admin_user, public_candidate_object, benchmark
):
    def check_accessibility():
        accessible = public_candidate_object.is_accessible_by(
            group_admin_user, mode="create"
...
def test_group_admin_user_create_public_source_object(
    group_admin_user, public_source_object, benchmark
):
    def check_accessibility():
        accessible = public_source_object.is_accessible_by(
            group_admin_user, mode="create"
...
def test_group_admin_user_create_keck1_telescope(
    group_admin_user, keck1_telescope, benchmark
):
    def check_accessibility():
...
def test_group_admin_user_create_sedm(group_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_group_admin_user_create_public_group_sedm_allocation(
    group_admin_user, public_group_sedm_allocation, benchmark
):
    def check_accessibility():
        accessible = public_group_sedm_allocation.is_accessible_by(
            group_admin_user, mode="create"
...
def test_group_admin_user_read_public_group(group_admin_user, public_group, benchmark):
    def check_accessibility():
...
def test_group_admin_user_read_sedm(group_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_group_admin_user_update_sedm(group_admin_user, sedm, benchmark):
    def check_accessibility():
...
def test_group_admin_user_delete_sedm(group_admin_user, sedm, benchmark):
    def check_accessibility():
