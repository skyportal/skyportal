...
CASES = [
    ...
    # --- AllocationUser  (public_allocation_user)  [PREDICTED - verify in CI] ---
    ...
    # --- CommentOnShift  (public_comment_on_shift)  [PREDICTED - verify in CI] ---
    ...
    # --- EventObservationPlan  (public_event_observation_plan)  [PREDICTED - verify in CI] ---
    ...
    # --- FacilityTransaction  (public_facility_transaction)  [PREDICTED - verify in CI] ---
    ...
    # --- GcnTrigger  (public_gcn_trigger)  [PREDICTED - verify in CI] ---
    ...
    ("user_group2", "public_gcn_trigger", "read", True),
    ...
    # --- GroupAnnotationOnPhotometry  (public_group_annotation_on_photometry)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupAnnotationOnSpectrum  (public_group_annotation_on_spectrum)  [PREDICTED - verify in CI] ---
    ("user", "public_group_annotation_on_spectrum", "create", True),
    ("user", "public_group_annotation_on_spectrum", "read", True),
    ...
    ("group_admin_user", "public_group_annotation_on_spectrum", "create", True),
    ("group_admin_user", "public_group_annotation_on_spectrum", "read", True),
    ("group_admin_user", "public_group_annotation_on_spectrum", "update", True),
    ("group_admin_user", "public_group_annotation_on_spectrum", "delete", True),
    ...
    # --- GroupCommentOnEarthquake  (public_group_comment_on_earthquake)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupCommentOnGCN  (public_group_comment_on_gcn)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupCommentOnShift  (public_group_comment_on_shift)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupCommentOnSpectrum  (public_group_comment_on_spectrum)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupDefaultAnalysis  (public_group_default_analysis)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupInvitation  (public_group_invitation)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupMMADetectorSpectrum  (public_group_mmadetector_spectrum)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupMMADetectorTimeInterval  (public_group_mmadetector_time_interval)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupObjAnalysis  (public_group_obj_analysis)  [PREDICTED - verify in CI] ---
    ...
    ("user_group2", "public_group_obj_tag", "read", True),
    ...
    # --- GroupPhotometricSeries  (public_group_photometric_series)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupPublicRelease  (public_group_public_release)  [PREDICTED - verify in CI] ---
    ...
    ("user_group2", "public_group_public_release", "create", False),
    ("user_group2", "public_group_public_release", "read", False),
    ...
    ("user_group2", "public_group_reminder", "create", True),
    ("user_group2", "public_group_reminder", "read", True),
    ...
    # --- GroupReminderOnEarthquake  (public_group_reminder_on_earthquake)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupReminderOnGCN  (public_group_reminder_on_gcn)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupReminderOnShift  (public_group_reminder_on_shift)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupReminderOnSpectrum  (public_group_reminder_on_spectrum)  [PREDICTED - verify in CI] ---
    ...
    # --- GroupSourceNotification  (public_group_source_notification)  [PREDICTED - verify in CI] ---
    ...
    # --- InstrumentSharingService  (public_instrument_sharing_service)  [PREDICTED - verify in CI] ---
    ...
    # --- MMADetectorTimeInterval  (public_mmadetector_time_interval)  [PREDICTED - verify in CI] ---
    ...
    # --- Obj  (public_obj_model)  [PREDICTED - verify in CI] ---
    ("user", "public_obj_model", "create", True),
    ("user", "public_obj_model", "read", True),
    ("user", "public_obj_model", "update", True),
    ("user", "public_obj_model", "delete", True),
    ("user_group2", "public_obj_model", "create", True),
    ("user_group2", "public_obj_model", "read", True),
    ("user_group2", "public_obj_model", "update", True),
    ("user_group2", "public_obj_model", "delete", False),
    ("group_admin_user", "public_obj_model", "create", True),
    ("group_admin_user", "public_obj_model", "read", True),
    ("group_admin_user", "public_obj_model", "update", True),
    ("group_admin_user", "public_obj_model", "delete", True),
    ("super_admin_user", "public_obj_model", "create", True),
    ("super_admin_user", "public_obj_model", "read", True),
    ("super_admin_user", "public_obj_model", "update", True),
    ("super_admin_user", "public_obj_model", "delete", True),
    ...
    # --- PhotStat  (public_phot_stat)  [PREDICTED - verify in CI] ---
    ...
    ("group_admin_user", "public_photometric_series", "read", True),
    ...
    # --- RecurringAPI  (public_recurring_api)  [PREDICTED - verify in CI] ---
    ...
    # --- Reminder  (public_reminder)  [PREDICTED - verify in CI] ---
    ...
    # --- ShiftUser  (public_shift_user)  [PREDICTED - verify in CI] ---
    ...
    # --- SpectrumObserver  (public_spectrum_observer)  [PREDICTED - verify in CI] ---
    ...
    # --- SpectrumPI  (public_spectrum_pi)  [PREDICTED - verify in CI] ---
    ...
    # --- SpectrumReducer  (public_spectrum_reducer)  [PREDICTED - verify in CI] ---
    ...
    ("user_group2", "public_stream_invitation", "create", True),
    ("user_group2", "public_stream_invitation", "read", True),
    ("user_group2", "public_stream_invitation", "update", False),
    ("user_group2", "public_stream_invitation", "delete", False),
    ("group_admin_user", "public_stream_invitation", "create", True),
    ("group_admin_user", "public_stream_invitation", "read", True),
    ...
    # --- StreamPhotometricSeries  (public_stream_photometric_series)  [PREDICTED - verify in CI] ---
    ...
    ("user_group2", "public_stream_photometric_series", "create", False),
    ("user_group2", "public_stream_photometric_series", "read", False),
    ...
    # --- StreamPhotometry  (public_stream_photometry)  [PREDICTED - verify in CI] ---
    ...
    # --- SurveyEfficiencyForObservations  (public_survey_efficiency_for_observations)  [PREDICTED - verify in CI] ---
    ...
    # --- Weather  (public_weather)  [PREDICTED - verify in CI] ---
