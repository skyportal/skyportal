...
def gcn_notification_content(session, target, app_url):
...
def source_notification_content(session, target, app_url):
...
def source_slack_notification(session, target, app_url):
    data = source_notification_content(session, target, app_url)
