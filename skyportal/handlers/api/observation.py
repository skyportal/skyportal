...
class ObservationExternalAPIHandler(BaseHandler):
    ...
    @permissions(["Upload data"])
    async def delete(
        self, allocation_id: int, *, body: ObservationExternalAPIDeleteBody = None
    ):
        """
        ---
...
class ObservationTreasureMapHandler(BaseHandler):
    @auth_or_token
    async def post(
        self, instrument_id: int, *, body: ObservationTreasureMapPostBody = None
    ):
        """
        ---
    ...
    @auth_or_token
    async def delete(
        self, instrument_id: int, *, body: ObservationTreasureMapDeleteBody = None
    ):
        """
        ---
