...
class PhotometryHandler(BaseHandler):
    ...
    async def post(self, *, body: PhotometryPostBody = None) -> PhotometryPostResponse:
        """
        ---
    ...
    @permissions(["Upload data"])
    async def put(self, *, body: PhotometryPutBody = None) -> PhotometryPutResponse:
        """
        ---
    ...
    @permissions(["Upload data"])
    def patch(self, photometry_id: int, *, body: PhotometryPatchBody = None):
        """
        ---
