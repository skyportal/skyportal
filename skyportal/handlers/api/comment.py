...
class CommentHandler(BaseHandler):
    ...
    def post(self):
              ...
              schema:
                ...
                properties:
                  ...
                  is_auto:
                    type: boolean
                    description: |
                        specify True when a robot makes the comment.
                        Defaults to False for human authors.
                  altdata:
                    type: object
                    description: machine readable (searchable) data in JSON format.
        ...
        # try to automatically parse common types of comments like "z=0.5"
        altdata = self.parse_text(comment_text, altdata)
