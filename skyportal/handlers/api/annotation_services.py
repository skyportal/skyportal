...
class GaiaQueryHandler(BaseHandler):
    @auth_or_token
    async def post(self, obj_id: str, *, body: GaiaQueryBody = None):
        """
        ---
...
class IRSAQueryWISEHandler(BaseHandler):
    @auth_or_token
    async def post(self, obj_id: str, *, body: IRSAQueryWISEBody = None):
        """
        ---
...
class VizierQueryHandler(BaseHandler):
    @auth_or_token
    async def post(self, obj_id: str, *, body: VizierQueryBody = None):
        """
        ---
...
class PS1QueryHandler(BaseHandler):
    @auth_or_token
    async def post(self, obj_id: str, *, body: PS1QueryBody = None):
        """
        ---
