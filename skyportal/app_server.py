...
skyportal_handlers = [
    ...
    (r'/api/sources(/.*)/photometry', ObjPhotometryHandler),
    (r'/api/sources(/.*)/spectra', ObjSpectraHandler),
    (r'/api/sources(/.*)/offsets', SourceOffsetsHandler),
    (r'/api/sources(/.*)/finder', SourceFinderHandler),
    (r'/api/sources(/.*)/classifications', ObjClassificationHandler),
    (r'/api/sources(/.*)/annotations', ObjAnnotationHandler),
    (r'/api/sources(/.*)/groups', ObjGroupsHandler),
    (r'/api/sources(/.*)/color_mag', ObjColorMagHandler),
