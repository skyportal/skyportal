...
skyportal_handlers = [
    ...
    (r'/api/moving_object/horizons', MovingObjectHorizonsHandler),
    (r'/api/moving_object/observation_plan', MovingObjectObservationPlanRequestHandler),
    (r'/api/moving_object(/[0-9A-Za-z-_\.\+]+)?', MovingObjectHandler),
