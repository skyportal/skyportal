...
from skyportal.handlers.api import (
    ...
    AnnotationHandler,
    AssignmentHandler,
    AssistantConversationHandler,
    AssistantMessageHandler,
    AssistantQueryHandler,
    AssistantQuerySubscriptionHandler,
    BrokerAlertsHandler,
    BrokerAPIsHandler,
...
skyportal_handlers = [
    ...
    (r"/api/brokers/([0-9]+)/credentials(?:/(topics))?", BrokerCredentialHandler),
    ...
    (r"/api/gcn_event/(.*)/extractions", GcnEventExtractionsHandler),
    (r"/api/gcn_event/properties", GcnEventPropertiesHandler),
    (r"/api/gcn_event/(.*)/summarize", GcnEventSummarizeHandler),
    ...
    (r"/api/assistant_queries(/[0-9]+)?", AssistantQueryHandler),
    (
        r"/api/assistant_queries/([0-9]+)/subscription",
        AssistantQuerySubscriptionHandler,
    ),
