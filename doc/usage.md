...
To set up `pre-commit` for automatically reformatting Python and JavaScript changes, make sure you have installed the dev dependencies (`uv sync --group dev`, see [Developer notes](dev)) and then run `pre-commit install`.
