...
latex_documents = [
  (master_doc, 'skyportal.tex', 'skyportal Documentation',
   'The skyportal Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'skyportal', 'skyportal Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'skyportal', 'skyportal Documentation',
   author, 'skyportal', 'One line description of project.',
   'Miscellaneous'),
]
