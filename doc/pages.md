...
Database Statistics Page: This page provides a list of typical database statistics, including the number of sources, photometry points, users, and other data, plus a plot of the rows added per time interval (candidates, sources, and other tables) over a selectable window. This page is only accessible to administrators.
/db_stats
